<template>
    <div class="home">
        <div class="page-item">
            <div class="content-title">废旧处置记录</div>
                        ...
                        <el-row>
                            ...
                            <el-col :span="6">
                                <el-form-item label="系统选择">
                                    <el-select v-model="form.systemType" placeholder="全部">
                                        <el-option
                            ...
                            <el-col :span="6">
                                <el-form-item label="处置原因" prop="status">
                                    <el-input
                        ...
                        <el-row>
                            <el-col :span="6">
                                <el-form-item label="责任人">
                                    <el-input
                                        v-model="form.responsibilityPerson"
                                        placeholder="责任人"
                                        @change="keyWordFormat"
                                    />
                                </el-form-item>
    ...
    methods: {
        ...
        open() {
            this.$confirm(`请确认导出数据${this.pagination.total}条`, {
                ...
                fileDownLoad({
                    url: '/ihs/monitor/device/statistics/exportScrapRecordList',
                    param: {
                        scarpStartTime: this.strTime,
                        scarpEndTime: this.endTime,
                        responsibilityPerson: this.form.responsibilityPerson,
        ...
        handleCurrentChange(val) {
            this.pagination.page_no = val; // eslint-disable-line
            this.getlist();
        },
    },
};
