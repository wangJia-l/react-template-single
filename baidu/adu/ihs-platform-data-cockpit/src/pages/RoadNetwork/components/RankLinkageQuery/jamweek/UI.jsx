...
import { DIRECTION, TIME_RANGE, ROAD_SECTION } from '../config';
import { jamWeekList } from '../TableItem/api';
const JamWeek = props => {
    const {
        getChild,
        getDefaultData = () => {},
    ...
    useEffect(() => {
        getDataA();
    }, [curDirection, pageParams, roadName]);
    return (
        <div className={Styles.TableModule}>
            <div className={Styles.title}>
                <span className={Styles.TitleLeft}></span>
                <span className={Styles.TitleText}>拥堵高发周排期</span>
            </div>
...
export default React.memo(JamWeek);
